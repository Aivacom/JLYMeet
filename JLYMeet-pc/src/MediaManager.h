...
#define  WM_JOIN_ROOM_SUCCESS	WM_USER + 100
#define  WM_LEAVE_ROOM			WM_USER + 101
#define  WM_USER_STOP_VIDEO     WM_USER + 102
#define  WM_USER_STOP_AUDIO     WM_USER + 103
#define  WM_TOKEN_WILL_EXPIRE   WM_USER + 104
#define  WM_VIDEO_CAPTURE_STATUS   WM_USER + 105
#define  WM_DEVICE_DETECTED   WM_USER + 106
